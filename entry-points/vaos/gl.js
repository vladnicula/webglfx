...
const GLInstance = (canvasNode) => {
  ...
  gl.mMeshCache = [] // cache all the mesh structs, easy to unload buffers if the all exist here
  ...
  gl.fCreateMeshVAO = (name, arrayIndex, arrayVertex, arrayNormals, arrayUVs) => {
    const instructions = {
    ...
    gl.mMeshCache[name] = instructions
    return instructions
  }
