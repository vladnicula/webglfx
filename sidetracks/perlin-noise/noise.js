...
function integrateWasmJS() {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'noise.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'noise.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'noise.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "noise.js.mem" : null;
...
var real__perlin2d = asm["_perlin2d"]; asm["_perlin2d"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__perlin2d.apply(null, arguments);
};
...
var _perlin2d = Module["_perlin2d"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_perlin2d"].apply(null, arguments) };
