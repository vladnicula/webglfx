...
function integrateWasmJS() {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'hello-world.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'hello-world.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'hello-world.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "hello-world.js.mem" : null;
...
var real__addNumbers = asm["_addNumbers"]; asm["_addNumbers"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__addNumbers.apply(null, arguments);
};
...
var _addNumbers = Module["_addNumbers"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_addNumbers"].apply(null, arguments) };
